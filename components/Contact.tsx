...
function GhostButton({ href, children }: { href: string; children: React.ReactNode }) {
  ...
  return (
    <a
      href={href}
      className="inline-flex items-center justify-center font-sans font-medium text-sm tracking-[0.12em] uppercase px-8 py-4 border transition-all duration-300 outline-none focus:outline-none w-full sm:w-auto text-center"
      style={{
        borderColor: '#F8F6F2',
        ...
        >
          ...
          {status === 'sent' ? (
            ...
            <button
              ...
              className="inline-flex items-center justify-center font-sans font-medium text-sm tracking-[0.12em] uppercase px-8 py-3 border transition-all duration-300 outline-none focus:outline-none w-full sm:w-auto"
              style={{
                borderColor: '#F8F6F2',
