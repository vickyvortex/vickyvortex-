      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row gap-16 md:gap-20 items-center">
          <div className="w-full md:w-[45%] flex-shrink-0">
            <img src="/images/VortexVitalityMethodHydrationwheel.png" alt="Vortex Vitality Method wheel" className="w-full max-w-[750px] mx-auto block" style={{ filter: 'invert(1) hue-rotate(180deg) saturate(0.8) brightness(0.9)' }} />
          </div>
